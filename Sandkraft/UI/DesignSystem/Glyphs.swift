...
enum Glyph: String, Hashable {
    ...
    case expand, collapse, beaches, centre
}
...
struct GlyphShape: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        // A reticle over a mark: put the view back on the middle of the beach.
        case .centre:
            circle(12, 12, 6.2)
            move(12, 1.6); line(12, 5)
            move(12, 19); line(12, 22.4)
            move(1.6, 12); line(5, 12)
            move(19, 12); line(22.4, 12)
            circle(12, 12, 1.2)
